...
sudo apt-get install -y php7.0-zip unzip
...
VHOST=$(cat <<EOF
<VirtualHost *:80>
    DocumentRoot "/var/www/html/${PROJECTFOLDER}/your-app/public"
    <Directory "/var/www/html/${PROJECTFOLDER}/your-app/public">
        AllowOverride All
        Require all granted
    </Directory>
</VirtualHost>
...
#composer install
composer create-project -s dev vhchung/slim3-skeleton-mvc your-app 
